...
This chart will install a mutating admission webhook, that injects an executable to containers in Pods which than can request secrets from SSM through environment variable definitions.
...
| env.SSM_ENV_IMAGE                | ssm-env image                                                                | `pwillie/ssm-env:0.1.2`      |
